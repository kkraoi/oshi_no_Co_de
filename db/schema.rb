...
ActiveRecord::Schema.define(version: 2025_07_18_074118) do
  ...
  create_table "achievements", force: :cascade do |t|
    ...
    t.index ["false_id"], name: "index_achievements_on_false_id"
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.decimal "recommend_score", precision: 5, scale: 3, default: "0.0", null: false
  ...
  add_foreign_key "achievements", "falses"
